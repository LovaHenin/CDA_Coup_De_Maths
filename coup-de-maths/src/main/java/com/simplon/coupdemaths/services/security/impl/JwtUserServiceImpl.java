package com.simplon.coupdemaths.services.security.impl;
...
public class JwtUserServiceImpl implements JwtUserService {
    ...
    public UserDetails loadUserByUsername(String username) throws
        ...
        OwnerRepositoryModel ownerRepositoryModel = ownerRepository.findByEmail(username);
        if (ownerRepositoryModel == null) {
    ...
    public UserDetails save(String username, String password) throws AccountExistsException {
        ...
        OwnerRepositoryModel ownerRepositoryModel = new OwnerRepositoryModel();
        ownerRepositoryModel.setEmail(username);
